(function(){
    ...
    var attrArray = ["Households", "For Rent", "Rented Long Term", "For Sale", "Seasonal Use", "Vacant"];// variables for data join
...
function setMap(){
    ...
    var credits = d3.select(".credits")
        .text("Data Source: U.S. Census Bureau; American Community Survey, ACS 2012-2017 5-year Estimate by Block Group; generated by Mason Bindl; using American FactFinder; <http://factfinder.census.gov>; (4 April 2017).");
    ...
    var promises = [];
        ...
        promises.push(d3.json("data/Houses_WGS84.topojson")); //load background spatial data
    ...
    function callback(data){
        ...
        //translate Block Groups to TopoJSON
//        var houses = topojson.feature(houses, houses.objects.Houses_WGS84),
        var tahoeBlockgroup = topojson.feature(blockgroup, blockgroup.objects.Tahoe_Block_Group_WGS84).features;
        
//        //add Houses to map
//        var buildings = map.append("path")
//            .datum(houses)
...
function changeAttribute(attribute, csvData){
    ...
    // get max values of currently expressed attribute
...
function setLabel(props){
    //label content
    var labelAttribute = expressed + ": " + d3.format(",")(props[expressed]);
    var cityLabel = props.City
    ...
    var labelAtt = infolabel.append("div")
