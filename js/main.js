...
function setMap(){
    ...
    var credits = d3.select(".credits")
        .text("Data Source: U.S. Census Bureau; American Community Survey, ACS 2012-2017 5-year Estimate; generated by Mason Bindl; using American FactFinder; <http://factfinder.census.gov>; (4 April 2017).");
